...
else insert node doc('../../content-models/pronunciation-form.xml') after (tei:def | tei:gramGrp | tei:usg | tei:ptr | tei:form[contains(' unknown-accentuation accentuation-variant ', @type)])[last()]
