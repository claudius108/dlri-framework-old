...
return insert node $processed-template after ($context-node | $context-node/following-sibling::tei:usg[@corresp = $corresp-value] | $context-node/following-sibling::tei:xr[@type = ('syn', 'remote-syn', 'analog', 'asoc') and @corresp = $corresp-value])[last()]	
