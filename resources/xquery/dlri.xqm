...
declare variable $dlri:term-unul.sau.mai.multe.sensuri-sensul-cf..etimon-cf.-template as element() :=
    <term xmlns="http://www.tei-c.org/ns/1.0" xml:lang="" type="unul.sau.mai.multe.sensuri-sensul-cf..etimon-cf." subtype="unknown" />
;
