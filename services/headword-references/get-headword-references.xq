...
declare function headword-references:run($currentElementLocation as xs:string) {
    ...
    return dlri-utils:updateDatalist("headword-entries", doc("http://188.212.37.221:8080/apps/dlri-app/services/headword-references/headword-references.xq?search-string=" || $search-string)/*/text())
};